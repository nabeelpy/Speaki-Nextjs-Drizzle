          ...
          <main className="flex flex-col w-full max-w-[1200px] mx-auto px-4 lg:px-10 py-10 pb-24 md:pb-10">
            ...
            <div className="bg-gradient-to-r from-[#137fec]/20 to-[#137fec]/5 rounded-2xl p-6 sm:p-8 mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-6">
                {/* Thumbnail */}
                <div className="w-full sm:w-44 sm:h-44 md:w-52 md:h-52 flex-shrink-0 rounded-xl overflow-hidden bg-slate-100 self-start">
                  <img
                ...
                <span className="inline-block self-start bg-[#137fec] text-white px-4 py-1 rounded-full text-sm font-bold tracking-wide">
                  {course.level}
                </span>
            ...
            <div className="mb-8">
              ...
              <div className="space-y-3">
                {course.lessons?.map((lesson: any, index: number) => (
                    ...
                    <span className="bg-[#137fec]/10 text-[#137fec] w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0">
                      {index + 1}
                    </span>
                        <div>
