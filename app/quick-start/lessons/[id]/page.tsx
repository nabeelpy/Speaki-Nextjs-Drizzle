...
import {
    SUPPORTED_LANGUAGES,
    VOICE_AGENTS,
    getVoiceAgentsForAccentDropdown,
...
export default function QuickStartLessonPage({
    ...
    // When language changes to non-English, switch to a valid voice agent for that language (so TTS speaks it). When English, keep selection so user can use any accent to read English.
    useEffect(() => {
        if (isEnglishLanguage(selectedLanguage)) return
                                ...
                                <div className="flex flex-wrap items-end gap-4">
                                    ...
                                    <div className="flex flex-col gap-1.5 min-w-[200px]">
                                        ...
                                        <Select value={selectedVoiceAgentId} onValueChange={setSelectedVoiceAgentId}>
                                            ...
                                            <SelectContent>
                                                {getVoiceAgentsForAccentDropdown(selectedLanguage).map((agent) => (
