...
/* ══════════════════════════════════════
   DESKTOP LAYOUT
══════════════════════════════════════ */
.al-desktop-layout { flex-direction: column; gap: 20px; align-items: stretch; width: 100%; }
...
/* Desktop controls + settings side-by-side */
.al-desk-bottom-row {
  display: flex;
  gap: 16px;
  align-items: flex-start;
...
/* Desktop settings panel (side card) */
.al-desk-settings {
  width: 240px;
  flex-shrink: 0;
  background: var(--surface);
...
export default function AudioLessonInterface({
    ...
    // ── Settings panel — desktop version (no avatar picker) ──────────────────
    ...
    return (
        <div className="al-root">
            ...
            {/* ════════════════════════════════
                DESKTOP LAYOUT — no mascot, settings beside controls
            ════════════════════════════════ */}
            <div className="al-desktop-layout">
                ...
                {/* Controls + Settings side by side */}
                <div className="al-desk-bottom-row">
                    ...
                    {/* Settings panel — sits to the right of controls */}
