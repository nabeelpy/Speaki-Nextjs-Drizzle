        ...
        "
                        ...
                        <DialogContent>
                            ...
                            <div className="space-y-5"> <div>
                                ...
                                <div className="grid grid-cols-2 gap-2"> {LEVELS.map((lvl) => ( <button key={lvl} onClick={() => setLevel(level === lvl ? null : lvl)} className={`px-3 py-2 rounded-md text-sm font-bold ${level === lvl ? 'bg-[#137fec] text-white' : 'bg-slate-100 dark:bg-slate-800'} `} >
                                    {/*{lvl}*/}
                                    {difficultyMap[lvl]}
                                </button> ))} </div> </div>
            ...
            <aside className="hidden md:block w-64 flex-shrink-0">
                <div className="bg-white dark:bg-slate-900 border border-[#e7edf3] dark:border-slate-800 rounded-lg p-4 space-y-6"> <div>
                    ...
                    <div className="grid grid-cols-2 gap-2"> {LEVELS.map((lvl) => ( <button key={lvl} onClick={() => setLevel(level === lvl ? null : lvl)} className={`px-3 py-2 rounded-md text-sm font-bold transition-colors ${level === lvl ? 'bg-[#137fec] text-white' : 'bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700'} `} > {difficultyMap[lvl]} </button> ))} </div> </div>
